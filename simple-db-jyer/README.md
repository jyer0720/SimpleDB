...
### Due: Thursday, March 21st, 2019

### Project Guidelines: This lab is part of the final project. See the final project instructions [here](https://courses.cs.washington.edu/courses/cse444/19wi/content/Project.html) for details.
...
The optimizer will be invoked from `simpledb/Parser.java`. You may wish to review the [lab 2 parser exercise](https://gitlab.cs.washington.edu/cse444-19wi/simple-db/blob/lab2/README.md) before starting this lab. Briefly, if you have a catalog file `catalog.txt` describing your tables, you can run the parser by typing:
...
* The schema of the IMDB database: [imdb.schema](http://www.cs.washington.edu/education/courses/cse444/19wi/labs/lab5/imdb.schema).
* A small 1% version of the IMDB database: [sample-0.01.tar.bz2](http://www.cs.washington.edu/education/courses/cse444/19wi/labs/lab5/sample-0.01.tar.bz2). This is the recommended version to use in the assignment. 
* In case your version of SimpleDB is too slow to handle the 1% dataset, we also provide 0.1% sample: [sample-0.001.tar.bz2](http://www.cs.washington.edu/education/courses/cse444/19wi/labs/lab5/sample-0.001.tar.bz2). 
* If you are feeling adventurous, here is the 10% version: [sample-0.1.tar.bz2](http://www.cs.washington.edu/education/courses/cse444/19wi/labs/lab5/sample-0.1.tar.bz2). Feel free to use it if you prefer.
...
You must submit your code (see below) as well as the final project report as per the instructions [here](https://courses.cs.washington.edu/courses/cse444/19wi/content/Project.html).
...
To git@gitlab.com:cse444-19wi/simple-db-pirateninja.git
 - [deleted]         lab5
...
To git@gitlab.com:cse444-19wi/hsimple-db-pirateninja.git
 * [new tag]         lab5 -> lab5
```
...
See the final project instructions [here](https://courses.cs.washington.edu/courses/cse444/19wi/content/Project.html).
...
```sh
$ git clone git@gitlab.com:cse444-19wi/simple-db-yourname
