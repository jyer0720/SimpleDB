...
public class JoinOptimizerTest extends SimpleDbTestBase {
    ...
    @Test
    public void bigOrderJoinsTest20() throws IOException, DbException,
    TransactionAbortedException, ParsingException {
final int IO_COST = 103;
...
HeapFile smallHeapFileR = createDuplicateHeapFile(smallHeapFileTuples,
        2, "c");
HeapFile smallHeapFileS = createDuplicateHeapFile(smallHeapFileTuples,
        2, "c");
HeapFile smallHeapFileT = createDuplicateHeapFile(smallHeapFileTuples,
        2, "c");
...
stats.put("q", new TableStats(smallHeapFileG.getId(), IO_COST));
stats.put("r", new TableStats(smallHeapFileG.getId(), IO_COST));
stats.put("s", new TableStats(smallHeapFileG.getId(), IO_COST));
stats.put("t", new TableStats(smallHeapFileG.getId(), IO_COST));
...
filterSelectivities.put("s", 1.0);
filterSelectivities.put("t", 1.0);
...
nodes.add(new LogicalJoinNode("t", "bigTable", "c0", "c0",
        Predicate.Op.EQUALS));
...
j = new JoinOptimizer(
        p.generateLogicalPlan(
                tid,
                "SELECT COUNT(a.c0) FROM bigTable, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t"
                + " WHERE bigTable.c0 = n.c0 AND a.c1 = b.c1 AND b.c0 = c.c0 AND c.c1 = d.c1 AND d.c0 = e.c0 AND e.c1 = f.c1 AND f.c0 = g.c0 AND g.c1 = h.c1 AND h.c0 = i.c0 AND i.c1 = j.c1 AND j.c0 = k.c0 AND k.c1 = l.c1 AND l.c0 = m.c0 AND m.c1 = n.c1 AND n.c0 = o.c0 AND o.c1 = p.c1 AND p.c0 = q.c0 AND q.c1 = r.c1 AND r.c0 = s.c0 AND s.c1 = t.c1;"),
        nodes);
